...
def use_additional_tools():
    ...
    for tool in tools:
        ...
        # Depuración: listar archivos en el directorio para spam-wa
        if tool['name'] == 'spam-wa' and os.path.exists(tool_dir):
            try:
        ...
        show_status_message(f"Verificando {tool['name']}: {tool_dir}", "info")
