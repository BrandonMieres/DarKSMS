#!/usr/bin/python
import requests,random,json,time,sys,os,re,platform
...
class spam:
	...
	def tokped(self):
		if os.path.exists('ua.txt'):
			...
			rands = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"
		kirim = {
			'User-Agent' : rands,
